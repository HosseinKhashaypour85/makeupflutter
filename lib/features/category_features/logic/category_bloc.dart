...
import 'package:makeupflutter/features/category_features/logic/category_state.dart';
...
class CategoryBloc extends Bloc<CategoryEvent, CategoryState>{
  ...
  CategoryBloc(this.repository) : super(CategoryInitial()) {
    on<CallCategoryEvent>((event, emit) async{
      ...
      try{
        final categories = await repository.callCategoriesApi();
        emit(CategoryCompletedState(categories: categories));
      }
